...
// Mirror defaults from config.h (zenoh-pico 1.9.0).
// 1.9.0 has unguarded calls into feature-gated functions — disabling most
// features causes implicit-declaration errors in library internals.
// Only change values here when you have verified the library guards them correctly.
...
#define Z_FEATURE_QUERY                  0 //no
#define Z_FEATURE_QUERYABLE              0 //no
...
#define Z_FEATURE_FRAGMENTATION          0 //no 
